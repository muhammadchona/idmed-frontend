...
<div ref="filterTptDailyRegisterSection">
  ...
  v-if="resultFromLocalStorage"
    ...
    bgColor="bg-orange-5">Serviço {{serviceAux !== null ? serviceAux.code : ''}}: Lista de Registro Diário de TPT
  </ListHeader>
  <ListHeader
  v-else
    :addVisible="false"
    ...
    :closeVisible="true"
    @closeSection="closeSection(params)"
    bgColor="bg-orange-5">Serviço {{selectedService !== null ? selectedService.code : ''}}: Lista de Registro Diário de TPT
  </ListHeader>
