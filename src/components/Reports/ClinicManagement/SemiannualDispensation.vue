...
<div ref="filterDPatientHistorySection">
  ...
  v-if="resultFromLocalStorage"
    ...
    bgColor="bg-orange-5">Serviço {{serviceAux !== null ? serviceAux.code : ''}}: Pacientes em Dispensa Semestral
  </ListHeader>
  <ListHeader
  v-else
    :addVisible="false"
    ...
    :closeVisible="true"
    @closeSection="closeSection(params)"
    bgColor="bg-orange-5">Serviço {{selectedService !== null ? selectedService.code : ''}}: Pacientes em Dispensa Semestral
  </ListHeader>
