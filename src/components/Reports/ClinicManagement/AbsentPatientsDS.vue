<template>
  <div ref="filterAbsentPatientSection">
    <ListHeader
      ...
      Faltosos ao levantamento para Dispensa semestral
    </ListHeader>
    <ListHeader
      v-else
      :addVisible="false"
      ...
      Pacientes Faltosos ao levantamento para Dispensa semestral
    </ListHeader>
...
import absentPatientsTs from 'src/services/reports/ClinicManagement/AbsentPatientsDS.ts';
...
const name = 'AbsentPatientsDS';
const props = defineProps(['selectedService', 'menuSelected', 'id', 'params']);
const totalRecords = ref(0);
const qtyProcessed = ref(0);
const report = 'FALTOSOS_AO_LEVANTAMENTO_DS';
